...
<head>
    ...
    <title>Dashboard Petugas - Bimantara Pustaka</title>
        ...
        <div class="header-content">
            ...
            <div class="profile-section">
                ...
                <div class="profile-info">
                    ...
                    <div class="profile-role">{{ Auth::user()->role ?? 'Petugas' }}</div>
                </div>
            </div>
        </div>
    </div>
...
<div class="content-wrapper">
    <div class="container">
        <div class="welcome-section fade-in">
            <h2>Selamat Datang di Dashboard Petugas, {{ Auth::user()->name ?? 'User' }}! 👋</h2>
